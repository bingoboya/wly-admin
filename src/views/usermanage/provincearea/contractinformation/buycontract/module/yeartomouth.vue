        ...
        <el-row :gutter="5">
          <el-col :span="8">
            <el-form-item
              ...
              prop="m01"
              :rules="[
                { required: true, message: '请输入1月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m01"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
              ...
              prop="m02"
              :rules="[
                { required: true, message: '请输入2月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m02"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
              ...
              prop="m03"
              :rules="[
                { required: true, message: '请输入3月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m03"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="5">
          <el-col :span="8">
            <el-form-item
              ...
              prop="m04"
              :rules="[
                { required: true, message: '请输入4月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m04"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
              ...
              prop="m05"
              :rules="[
                { required: true, message: '请输入5月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m05"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
              ...
              prop="m06"
              :rules="[
                { required: true, message: '请输入6月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m06"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="5">
          <el-col :span="8">
            <el-form-item
              ...
              prop="m07"
              :rules="[
                { required: true, message: '请输入7月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m07"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
              ...
              prop="m08"
              :rules="[
                { required: true, message: '请输入8月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m08"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
              ...
              prop="m09"
              :rules="[
                { required: true, message: '请输入9月份电量', trigger: 'blur' },
              ]"
            >
              <el-input
                v-model="yearToMonthDetail.m09"
                autocomplete="off"
              />
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    erbi(value) {
      ...
      for (const item in this.yearToMonthDetail) {
        if (item.startsWith('m')) {
          const aa = this.yearToMonthDetail[item]
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          const params = JSON.parse(JSON.stringify(that.yearToMonthDetail))
          if (!that.chooseStyle) { // 如果是比例值,提交前转换成电量值
            for (const item in params) {
              if (item.startsWith('m')) {
                const bb = params[item]
