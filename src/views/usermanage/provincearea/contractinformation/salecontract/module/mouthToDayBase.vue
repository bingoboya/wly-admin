<template>
  ...
  >
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button
        type="primary"
        @click="dialogMouthToDayBase.toggle = false"
      >取 消</el-button>
    ...
    <mouthToDayDetial
      ...
      :day-propetie-list="dayPropetieList"
      :table-data="tableData"
      :year-to-mon-percentage-all-data="yearToMonPercentageAllData"
      :year-to-mon-percentage1="yearToMonPercentage1"
      :year-to-mon-percentage2="yearToMonPercentage2"
  ...
  methods: {
    ...
    submitForm(formName, type) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          const ar = JSON.parse(JSON.stringify(this.mouthToDayBaseDetail))
          const res = {
            name: ar.name,
    ...
    getMouthToDayDetail(selectId, month) {
      ...
      request({
        ...
        url: `/buy/${contractId}/${selectId}/detail?month=${month}&type=1`,
        method: 'get'
      })
        .then((res) => {
    ...
    getMouthToDayBasic() {
      ...
      request({
        // id是在  /buy  接口处获取到的
        url: `/buy/${contractId}/mtod/${this.id}/basic?type=1`,
        method: 'get'
      }).then((res) => {
