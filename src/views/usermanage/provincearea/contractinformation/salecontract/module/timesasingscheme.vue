<template>
  ...
  >
    ...
    <div slot="footer" class="dialog-footer">
      <!-- 另存 不传当前分时方案id-->
      <el-button @click="submitForm('ruleForm', 'add')" type="primary">另存</el-button>
      <!-- 保存 -》传入当前分时方案id -->
      <el-button @click="submitForm('ruleForm', 'save')" type="primary">保存</el-button>
      <!-- 自定义进来时才有 保存并选择-->
      <el-button v-if='id == 999' @click="submitForm('ruleForm', 'saveselected')" type="primary" >保存并选择</el-button>
      <el-button @click="showDialogFormVisible.toggle = false" type="primary" >取 消</el-button>
