...
export default {
  ...
  methods: {
    ...
    formatDivisionData() {
      const data = ['0点', '1点', '2点', '3点', '4点', '5点', '6点', '7点', '8点', '9点', '10点', '11点', '12点', '13点', '14点', '15点', '16点', '17点', '18点', '19点', '20点', '21点', '22点', '23点']
      // let rest = []
      ...
      // }
      // this.rest = rest
      const arr = Array.from({ length: this.rest.length }).map(
        (v, k) => `${k + 1}点`
      )
      return arr
    },
    initChart() {
      console.log(123454, this.rest)
